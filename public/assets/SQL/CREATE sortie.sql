...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 26 juin 2023 à 14:00
...
('DoctrineMigrations\\Version20230626122011', '2023-06-26 13:26:52', 179);
...
CREATE TABLE IF NOT EXISTS `inscription` (
  ...
  `activities_activity_no` int NOT NULL,
  `participants_participant_no` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `place` (
  ...
  `place_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `place_street` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
